            ...
            <Layout>
                <BreadCrumbs>
                    <ul className='flex items-center gap-3'>
                        ...
                        <li className=' flex space-x-3 items-center' >
                            <Link href={"/index"} className="flex gap-1 items-center text-[#3bb77e] hover:text-orange-300">
                            ...
                            <div>
                                ...
                                <div className=''>
                                    ...
                                    flex justify-between items-center flex-wrap gap-8'>
                                        <div>
                                            <p className=''>We have <strong className='text-green-black'>780</strong> index now</p>
                                        </div>
