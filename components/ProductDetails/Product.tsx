    ...
    return (
            ...
            <div className={'flex flex-col xl:flex-row justify-between gap-14 w-full'}>
                ...
                <div className={'space-y-8'}>
                    ...
                    <h3 className={'text-2xl sm:text-4xl font-bold text-primary-text'}>Seeds of Change Organic Quinoa, Brown</h3>
                    <div className={'flex items-center gap-2'}>
                        <Rating/>
                        <span className={'text-sm text-gray-400 font-medium'}>(32) Reviews</span>
                    </div>
                    <div className={'flex items-center gap-4'}>
                        <h2 className={'text-3xl sm:text-5xl text-primary font-bold'}>$32</h2>
                        <div>
                            <h4 className={''}>
                                <span className={'line-through text-xl sm:text-2xl font-bold text-gray-300'}>$52</span>
                    ...
                    <div className={'flex items-center gap-4 sm:gap-2 flex-wrap'}>
                       <ProductQuantity setQuantity={setQuantity} quantity={quantity}/>
                        <button
                            ...
                            <span className={'sm:text-xl font-bold'}>Add to cart</span>
                        </button>
                        <button
                            className={'px-3.5 py-3.5 xs:py-4 xs:px-4 rounded hover:bg-primary hover:text-white text-gray-400 border border-gray-200 duration-300 hover:-translate-y-1'}>
                    ...
                    <div>
                        <ul className={'text-sm font-semibold grid xs:grid-cols-2 gap-2'}>
                            ...
                            <li className={'flex items-center gap-1'}>
                                <span className={'text-gray-400 basis-14 sm:basis-12'}>LIFE:</span>
                                <span className={'text-primary'}>70 days</span>
                            </li>
                            <li className={'flex items-center gap-1'}>
                                <span className={'text-gray-400 basis-14 sm:basis-12'}>Stock:</span>
