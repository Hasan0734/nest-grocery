...
const GridCard = ({ background = "bg-primary",
        ...
        hover:shadow-[0_5px_8px_rgba(0,0,0,0.06)] p-5 rounded-2xl relative overflow-hidden'>
            ...
            <div>
                <div className='flex justify-between items-center'>
                    ...
                    <div>
                        <button className='bg-[#DEF9EC] px-3 py-1
                         text-primary font-bold rounded-md text-xs'>{vendor.total_products} products</button>
                    </div>
                </div>
                <div className=''>

                    <h3 className='text-2xl text-gray-black font-bold mb-1'>
                        <Link href={`/store-listing/${vendor.id}`}>{vendor.name}</Link>
                    </h3>
                ...
                <div className='mt-8 mb-4'>
                    <Link href={`/store-listing/${vendor.id}`} className='font-bold text-white text-sm bg-primary px-3 py-2 rounded-md'>
