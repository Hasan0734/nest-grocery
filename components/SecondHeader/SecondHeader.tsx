                    ...
                    <div className='flex flex-col xl:flex-row  gap-8  xl:items-center w-full'>
                        <div className='flex justify-between'>
                            ...
                            <ul className=' flex lg:hidden  space-x-5 items-center'>
                                ...
                                <li className='flex items-center space-x-1 cursor-pointer relative'>
                                    <ShoppingCartIcon className='w-8 text-gray-600' />
                                    <div className='absolute p-1 -top-2 -right-1 rounded-full w-6 h-6 flex justify-center items-center bg-[#3BB77E] text-white'>
                                        <span>0</span>
                                    </div>
                                </li>
